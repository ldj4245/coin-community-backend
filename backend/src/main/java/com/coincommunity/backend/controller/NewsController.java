...
public class NewsController {
    ...
    @GetMapping
    public ResponseEntity<com.coincommunity.backend.dto.ApiResponse<PageResponse<NewsDto.NewsSummaryResponse>>> getAllNews(
    ...
    @GetMapping("/{id}")
    public ResponseEntity<com.coincommunity.backend.dto.ApiResponse<NewsDto.NewsResponse>> getNewsById(
    ...
    @GetMapping("/search")
    public ResponseEntity<com.coincommunity.backend.dto.ApiResponse<PageResponse<NewsDto.NewsSummaryResponse>>> searchNews(
    ...
    public ResponseEntity<com.coincommunity.backend.dto.ApiResponse<PageResponse<NewsDto.NewsSummaryResponse>>> getNewsBySource(
    ...
    @GetMapping("/by-date")
    public ResponseEntity<com.coincommunity.backend.dto.ApiResponse<PageResponse<NewsDto.NewsSummaryResponse>>> getNewsByDateRange(
    ...
    @GetMapping("/recent")
    public ResponseEntity<com.coincommunity.backend.dto.ApiResponse<List<NewsDto.NewsSummaryResponse>>> getRecentNews() {
        List<NewsDto.NewsSummaryResponse> news = newsService.getRecentNews();
        return ResponseEntity.ok(com.coincommunity.backend.dto.ApiResponse.success(news));
    }
    ...
    @GetMapping("/popular")
    public ResponseEntity<com.coincommunity.backend.dto.ApiResponse<List<NewsDto.NewsSummaryResponse>>> getPopularNews() {
